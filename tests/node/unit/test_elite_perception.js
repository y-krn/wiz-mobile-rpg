...
import { ELITE_PERCEPTIONS, getPerceptionIntent, isInPlayerLineOfSight } from "../../../src/systems/elite_perception.js";
...
assert.deepEqual(ELITE_PERCEPTIONS, ["sound", "blind_charge", "vibration", "standard", "afterimage"]);
...
assert.equal(isInPlayerLineOfSight(player, monster("afterimage"), [[{}]]), false);
...
console.log("[PASS] elite perception");
