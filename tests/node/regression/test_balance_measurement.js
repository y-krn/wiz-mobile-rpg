...
assert.match(workflow, /contains\(fromJSON\('\["build-progression-audit", "build-progression-pareto-safe"\]'\), inputs\.measurement\) && 45 \|\| 20/);
assert.match(workflow, /contains\(fromJSON\('\["build-progression-audit", "build-progression-pareto-safe"\]'\), inputs\.measurement\) && 30 \|\| 15/);
