...
assert.match(workflow, /contains\(fromJSON\('\["build-progression-audit", "build-progression-pareto-safe", "preparation-power-factorial", "first-band-build-formation", "first-band-transition-recovery"\]'\), inputs\.measurement\) && 45 \|\| 20/);
assert.match(workflow, /contains\(fromJSON\('\["build-progression-audit", "build-progression-pareto-safe", "preparation-power-factorial", "first-band-build-formation", "first-band-transition-recovery"\]'\), inputs\.measurement\) && 30 \|\| 15/);
