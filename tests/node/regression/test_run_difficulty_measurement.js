...
assert.equal(report.configuration.portalPolicyId, "p0");
assert.equal(report.configuration.portalHpThreshold, 0.35);
assert.equal(report.configuration.portalMinFloor, 3);
assert.equal(report.configuration.portalMaxHealPotions, 0);
