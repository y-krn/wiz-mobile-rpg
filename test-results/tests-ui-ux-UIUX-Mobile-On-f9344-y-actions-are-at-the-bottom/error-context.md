...
- Name: tests/ui-ux.spec.js >> UIUX Mobile One-Handed Operation tests on iPhone 13 (390x844) >> Check all visible buttons are at least 44px high and key actions are at the bottom
...
```ts
  ...
  16  |       });
> 17  |       await page.goto('http://localhost:5175/');
      |                  ^ Error: page.goto: net::ERR_ABORTED at http://localhost:5175/
  18  |       await page.waitForTimeout(1000);
  19  |       await page.screenshot({ path: `/Users/ottan/.gemini/antigravity/scratch/${vp.name}-start.png` });
  20  |     });
  21  | 
  ...
  27  |         await page.screenshot({ path: `/Users/ottan/.gemini/antigravity/scratch/screen-${screenName.replace(/\s+/g, '_')}-${vp.name}.png` });
