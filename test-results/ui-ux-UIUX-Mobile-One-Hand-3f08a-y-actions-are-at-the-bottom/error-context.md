...
- Name: ui-ux.spec.js >> UIUX Mobile One-Handed Operation tests on iPhone 14 Pro Max (430x932) >> Check all visible buttons are at least 44px high and key actions are at the bottom
