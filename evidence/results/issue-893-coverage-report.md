...
`scratch/simulations/sim_depth_material_ev.js` remains the canonical `run` runner. The
...
`scratch/tests/regression/test_sim_path_determinism.js` verifies repeated identical output,
...
`scratch/tests/regression/test_sim_equipment_craft.js` verifies repeated identical
