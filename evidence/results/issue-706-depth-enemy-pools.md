...
- The earlier implementation source `6351f22181cb0275109d3b74fdabb431e0a0dbf5`
  ...
  changed only `scratch/measurements/issue624_commit_depth.js` and this summary; it did not
  change `src/`, `scratch/simulations/sim_depth_material_ev.js`, or the Issue #706 runner.
...
- Full-depth runner: `scratch/measurements/issue624_commit_depth.js`, baseline-portal-flee,
...
- Exact baseline command/config:
  `node scratch/measurements/issue624_commit_depth.js`; `SIM_SEED=231`,
...
- Current-head floor/status runner: `scratch/measurements/issue706_depth_enemy_pools.js`,
...
node --check scratch/measurements/issue706_depth_enemy_pools.js
env -i PATH=/usr/local/bin:/opt/homebrew/bin:/usr/bin:/bin ISSUE706_SMOKE=1 SIM_RUNS=1 SIM_CALIBRATION_RUNS=1 node scratch/measurements/issue706_depth_enemy_pools.js
node scratch/tests/regression/test_enemy_pools.js
env -i PATH=/usr/local/bin:/opt/homebrew/bin:/usr/bin:/bin node scratch/measurements/issue706_depth_enemy_pools.js
