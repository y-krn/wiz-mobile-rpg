...
```sh
SIM_SEED=480 SIM_RUNS=1000 SIM_CALIBRATION_RUNS=100 TRAP_POLICY=legacy node scratch/simulations/sim_issue_480_floor_trap_policy.js
SIM_SEED=480 SIM_RUNS=1000 SIM_CALIBRATION_RUNS=100 TRAP_POLICY=conservative node scratch/simulations/sim_issue_480_floor_trap_policy.js
```
