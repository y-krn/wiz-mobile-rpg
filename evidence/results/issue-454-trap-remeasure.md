...
再現コマンド: `CI=true SIM_RUNS=50000 SIM_CALIBRATION_RUNS=100 SIM_DIAGNOSTICS=off TQ_CONDITIONS=trapBonus-5x-current TQ_SCENARIOS=workshop-core-pools node scratch/simulations/sim_issue_271_trap_quality.js`。
