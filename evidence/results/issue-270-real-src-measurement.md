...
再現コマンド（変更前src状態）: `node scratch/simulations/sim_depth_material_ev.js`
...
再現コマンド（変更後src状態）: `node scratch/simulations/sim_depth_material_ev.js`
...
- `node scratch/simulations/sim_depth_material_ev.js`: exit 0
...
- `node scratch/simulations/sim_workshop_progression.js`
