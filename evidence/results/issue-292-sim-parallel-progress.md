...
- 対象:
  - `scratch/simulations/sim_depth_material_ev.js`: scenario単位
  - `scratch/simulations/sim_workshop_progression.js`: trial単位（trial内runの状態依存は維持）
- 比較予定: `SIM_PARALLEL=1/4/8/最大`

## 2026-07-29 depth変更前 基準測定

- コマンド: `node scratch/simulations/sim_depth_material_ev.js`
...
- 生出力: `evidence/results/issue-292-depth-before.raw.txt`
- time出力: `evidence/results/issue-292-depth-before.time.txt`
...
- コマンド: `SIM_PARALLEL=1 node scratch/simulations/sim_workshop_progression.js`
...
- 生出力: `evidence/results/issue-292-workshop-before.raw.txt`
- time出力: `evidence/results/issue-292-workshop-before.time.txt`
