...
```sh
node --check scratch/simulations/sim_issue_594_selector_before_after.js
ISSUE594_SMOKE=1 node scratch/simulations/sim_issue_594_selector_before_after.js
node scratch/simulations/sim_issue_594_selector_before_after.js
```
