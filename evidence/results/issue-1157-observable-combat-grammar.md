...
| Enemy HP | Enemy HP is a visible Canvas bar; the accessible target list exposes exact `hp/maxHp` after opening target selection. | [`renderer.js`](../../src/renderer.js#L1765), [`combat_overlay.js`](../../src/combat_ui/combat_overlay.js#L114) | Current/max HP are observable after opening target selection; defense, evasion, and trait parameters remain undisclosed. |
