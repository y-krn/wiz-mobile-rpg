...
| --- | --- | --- |
| Repeated `#14141a`, `#22222d`, `#101014`, `#0c0c0e` in combat/equipment/spell/result overlays | Token candidate / legacy surface drift | Added `surface-control`, `border-control`, `surface-deep`, and `surface-unavailable`; migrated only these repeated responsibilities, preserving pixels. |
