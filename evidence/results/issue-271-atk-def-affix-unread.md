...
- `scratch/tests/unit/test_core_affixes.js`
...
calibration N=500。`scratch/simulations/sim_issue_271_resistance_integrity.js`。
...
詳細: `evidence/results/issue-271-atk-def-comparison.md`。
...
- `node scratch/tests/unit/test_core_affixes.js`: exit 0
- `node scratch/tests/regression/test_sim_reward_paths.js`: 23 sim file PASS、exit 0
