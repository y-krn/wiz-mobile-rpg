...
- runner: `scratch/measurements/issue624_commit_depth.js` の `baseline-portal-flee`。B21到達、4職各N=500、`SIM_SEED=231`、`SIM_CALIBRATION_RUNS=100`、`SIM_PARALLEL` 未指定、実行時 parallelism=15。
...
node --check scratch/simulations/sim_commit_depth_624.js
ISSUE624_SMOKE=1 ISSUE732_DAMAGE_METRICS=1 node scratch/measurements/issue624_commit_depth.js
ISSUE732_DAMAGE_METRICS=1 node scratch/measurements/issue624_commit_depth.js
```
