...
- No `scratch/measurements/issue624_*.js` or `scratch/measurements/issue612_exp_pace_env.js` changes.
...
- `node scratch/tests/regression/test_damage_estimate_audit.js`: pass; pendingless hit excluded/counts, matched hit has no fallback marker, normal audited run has zero unmatched hits
- `node scratch/tests/regression/test_sim_reward_paths.js`: pass
- `node scratch/tests/unit/test_sim_recovery_supply.js`: pass
- `node scratch/tests/unit/test_heal_priority_policy.js`: pass
