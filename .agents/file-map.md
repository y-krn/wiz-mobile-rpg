...
| Global HUD, logs, goal banner, overlays | `src/ui.js`, `src/ui/*`, `src/style.css` | `src/state.js`, `src/state/*`, screen module being rendered | `npm run test:browser` |
| Town menu and generic submenu flow | `src/menu.js`, `src/menu/*`, `src/navigation.js` | `src/ui.js`, `src/ui/*`, `src/style.css` | `npm run test:browser` |
| Shop | `src/shop.js`, `src/shop/*` | `src/data.js`, `src/data/*`, `src/rules/*`, `src/state.js`, `src/state/*`, `src/menu.js`, `src/menu/*`, `src/style.css` | `npm run test:browser` |
...
| Equipment and inventory | `src/equip.js`, `src/data.js`, `src/data/*`, `src/rules/*`, `src/state.js`, `src/state/*` | `src/menu.js`, `src/menu/*`, `src/shop.js`, `src/shop/*`, `src/chest.js`, `src/style.css` | `npm run test:unit`, `npm run test:browser` |
...
| Combat UI and action selection | `src/combat.js`, `src/combat_ui/*`, `src/ui.js`, `src/ui/*`, `src/style.css` | `src/combat_logic.js`, `src/combat_logic/*`, `src/data.js`, `src/data/*`, `src/state.js`, `src/state/*` | `npm run test:unit`, `npm run test:browser` |
...
| `mobile-ui-ux` | `src/style.css`, affected UI module or overlay module, `tests/ui-ux.spec.js` | `src/ui.js`, `src/ui/*`, `src/menu.js`, `src/menu/*`, `src/combat_ui/*`, `src/navigation.js`, screenshots or browser observations |
