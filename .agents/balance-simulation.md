...
| id | category/slot | gate | params | class | status | R/C/E/Q/A | E/C Wilson | A/Q Wilson |
|---|---|---|---|---|---|---|---|---|
...
| treasureSense | `SUPPORT_AFFIXES`; treasure-sense base-item pools and floor gates | Same candidate/equip path | `src/chest.js:inspectChest` → `src/chest/chest_domain.js` trap inspection / loot-hint information only; never reward candidate or weight selection | C/sim-missing probe coverage | <!-- doc-path-ignore -->
...
| treasureSense | basic/weapon/armor/shield/accessory | B1 accessory / B3 equipment | 宝箱の罠調査と戦利品の気配を読み取る精度が増加する。 cost=2 unit=% | C/sim-missing | 19/19/10/0/0 | 52.6% [31.7,72.7] | — (sim-missing) |
