...
combined `trapBonus`/`trapSense` investment also contributes to automatic flame-trap
warning avoidance through the character-stats helper. Chest traps keep a
