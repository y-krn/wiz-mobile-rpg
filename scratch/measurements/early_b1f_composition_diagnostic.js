...
function buildSummary(report) {
  ...
  lines.push(
    ...
    "",
    "- cadence candidate changes only opening pair exposure; pool candidate redistributes named early pairs to an existing legal pair; ordering candidate defers a named early pair and releases it at encounter 2.",
