...
const RAW_RELATIVE_PATH = "evidence/results/issue-624-commit-depth.raw.jsonl";
...
function environmentSignature(env, condition, sourceCommit, baseCommit) {
  return {
    ...
    sourceCommit,
    baseCommit,
    runner: "scratch/measurements/issue624_commit_depth.js -> scratch/simulations/sim_commit_depth_624.js",
