...
// 使い方: node scratch/measurements/compare_env_signature.js <fileA.log> <fileB.log> [label]
...
if (!fileA || !fileB) {
  console.error("usage: node scratch/measurements/compare_env_signature.js <fileA> <fileB> [label]");
  process.exit(64);
}
