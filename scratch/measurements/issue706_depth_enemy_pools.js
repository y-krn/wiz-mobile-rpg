...
const sim = await import("../simulations/sim_depth_material_ev.js");
...
async function main() {
  ...
  const result = {
    ...
    runner: "scratch/measurements/issue706_depth_enemy_pools.js -> scratch/simulations/sim_depth_material_ev.js simulateRun",
