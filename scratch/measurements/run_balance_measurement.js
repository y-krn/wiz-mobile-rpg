...
export const MEASUREMENT_FAMILIES = Object.freeze({
  ...
  "progression-exp-b-full-run-diagnostic": freezeFamily({
    runner: "scratch/measurements/progression_exp_b_full_run_diagnostic.js",
    adapter: "native-manifest",
    defaultRunType: "diagnostic",
    allowedRunTypes: DIAGNOSTIC_ONLY_RUN_TYPES,
    artifactPrefix: "balance-measurement",
...
const PROFILE_LIST = [
  ...
  {
    id: "progression-exp-b-full-run-diagnostic",
    label: "Phase 4c v1 / Phase 4j-B full-run EXP diagnostic",
    family: "progression-exp-b-full-run-diagnostic",
    defaults: { runs: 30, minimumRuns: 30, seed: 1735 }
  },
  {
