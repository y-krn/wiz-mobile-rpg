...
const RAW_PATH = "scratch/results/issue-713-trap-calibration.raw.jsonl";
const SUMMARY_PATH = "scratch/results/issue-713-trap-calibration.md";
...
function renderSummary({ sourceCommit, baseCommit, rawSha256, cases }) {
  const lines = [
    ...
    `- real-run path: \`scratch/sim_issue_713_trap_calibration.js\` → \`simulateRun\` → \`generateRunFloor\``,
    ...
    "",
    "```sh",
    "SIM_RUNS=500 SIM_SEED=231 SIM_CALIBRATION_RUNS=100 env -u SIM_PARALLEL node scratch/sim_issue_713_trap_calibration.js",
    "```",
    "",
