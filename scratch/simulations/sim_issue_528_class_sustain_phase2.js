...
function renderMarkdown({ rows, summaries, measurement, rawSha256, provenance }) {
  ...
  lines.push(
    ...
    "",
    "```sh",
    "node --check scratch/simulations/sim_issue_528_class_sustain_phase2.js",
    "ISSUE528_PHASE2_SMOKE=1 node scratch/simulations/sim_issue_528_class_sustain_phase2.js",
    "node scratch/simulations/sim_issue_528_class_sustain_phase2.js",
    "```",
    ""
  );
  return lines.join("\n");
...
async function main() {
  ...
  console.log(JSON.stringify({
    output: "evidence/results/issue-528-class-sustain-phase2.md",
