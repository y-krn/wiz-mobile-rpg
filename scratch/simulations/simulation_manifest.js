...
export const SIMULATION_RUNNER_INVENTORY = Object.freeze([
  ...
  { path: "scratch/measurements/trait_scaling_diagnostic.js", lifecycle: "reusable", scope: "run" },
  { path: "scratch/measurements/composition_trait_diagnostic.js", lifecycle: "reusable", scope: "run" },
  { path: "scratch/measurements/milestone_boss_diagnostic.js", lifecycle: "reusable", scope: "run" },
...
export const SIMULATION_MANIFEST = Object.freeze({
  ...
  balanceImpactPaths: Object.freeze([
    ...
    { pattern: "src/rules/spell_targeting.js", domains: ["combat"] },
    { pattern: "src/rules/spell_rules.js", domains: ["combat"] },
    ...
    { pattern: "src/rules/equipment_load.js", domains: ["combat", "equipment"] },
    ...
    { pattern: "src/rules/material_rules.js", domains: [] },
    ...
    { pattern: "src/systems/identification.ts", domains: ["equipment"] },
    { pattern: "src/systems/omens.js", domains: ["maps"] },
    { pattern: "src/systems/omens.ts", domains: ["maps"] },
    ...
    { pattern: "src/data/weapon_behavior_profiles.js", domains: ["combat", "equipment"] },
    { pattern: "src/systems/leveling.js", domains: ["progression"] },
    { pattern: "src/systems/leveling.ts", domains: ["progression"] },
  ...
  balanceImpactNone: Object.freeze([
    ...
    "src/game.js", "src/main.js", "src/navigation.js", "src/menu.js", "src/menu/**", "src/renderer.js", "src/rules/map_movement.js", "src/state.js", "src/state/view_state.js", "src/state/view_state.ts", "src/state/renderer_view.js", "src/state/renderer_view.ts", "src/state/equipment.js", "src/state/equipment.ts", "src/state/item.js", "src/state/item.ts",
    ...
    "src/state/initial_state.js", "src/state/records_state.js", "src/state/state_core.js", "src/state/character.js", "src/state/character.ts", "src/state/monster.js", "src/state/monster.ts", "src/result.js", "src/rules/renderer_topology.js", "src/chest_prop.js", "src/dungeon_prop.js", "src/renderer_selection.js", "src/renderer_runtime.js",
    ...
    "src/rules/item_inventory.js", "src/rules/object_loot_stake.js", "src/rules/renderer_projection.js", "src/rules/enemy_hp_state.js", "src/rules/enemy_hp_state.ts",
