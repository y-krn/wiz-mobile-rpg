...
export const SIMULATION_RUNNER_INVENTORY = Object.freeze([
  ...
  { path: "scratch/measurements/progression_enemy_candidate_diagnostic.js", lifecycle: "reusable", scope: "run" },
  ...
  { path: "scratch/measurements/progression_exp_b_full_run_diagnostic.js", lifecycle: "reusable", scope: "run" },
...
export const SIMULATION_MANIFEST = Object.freeze({
  ...
  balanceImpactPaths: Object.freeze([
    ...
    { pattern: "src/rules/spell_targeting.ts", domains: ["combat"] },
    ...
    { pattern: "src/rules/exploration_rules.ts", domains: ["maps"] },
  ...
  balanceImpactNone: Object.freeze([
    ...
    "src/combat_ui/spell_summary.js", "src/combat_ui/spell_summary.ts", "src/combat_ui/combat_overlay.js", "src/combat_log_semantics.js", "src/combat_log_semantics.ts", "src/spell_menu.js",
    ...
    "src/state/initial_state.js", "src/state/records_state.js", "src/state/state_core.js", "src/state/character.js", "src/state/character.ts", "src/state/monster.js", "src/state/monster.ts", "src/result.js", "src/rules/renderer_topology.js", "src/rules/renderer_topology.ts", "src/chest_prop.js", "src/dungeon_prop.js", "src/renderer_selection.js", "src/renderer_selection.ts", "src/renderer_runtime.js",
