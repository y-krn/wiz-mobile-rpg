...
export const SIMULATION_MANIFEST = Object.freeze({
  ...
  balanceImpactNone: Object.freeze([
    ...
    "src/state/save_contract.js", "src/state/save_contract.ts", "src/state/run_state.js", "src/state/run_state.ts", "src/state/run_return_state.ts", "src/state/run_record_result.ts", "src/state/event_observation.ts", "src/state/material_state.js", "src/state/material_state.ts", "src/state/milestone_state.js", "src/state/milestone_state.ts", "src/state/camp_state.js", "src/state/camp_state.ts", "src/state/run_seed.js", "src/state/run_seed.ts", "src/state/run_quest.js", "src/state/run_quest.ts", "src/state/pending_reward.js", "src/state/pending_reward.ts", "src/state/trial_band.ts", "src/state/elite_floor.ts", "src/state/floor_steps.ts",
