...
${measurement.mode === "reaggregate"
  ? "SIM_REAGGREGATE_ONLY=1 node scratch/simulations/sim_issue_461_baseline.js"
  : `SIM_RUNS=${measurement.runsPerClass} SIM_CALIBRATION_RUNS=${measurement.calibrationRuns} node scratch/simulations/sim_issue_461_baseline.js`}
${"```"}
