...
## 結論: 深層生存で完成度を判定できない（測定した候補に A1 を満たす定義なし）
...
正式候補 7 個、A1 predicate 21 個。α=.05の期待偽陽性数 1.05（Bonferroni family-wise α=0.00238）。候補追加による数字合わせはしない。
...
- summary JSON SHA-256: `2d38577845404f35c897af1742f740e6dc00027a4361678e11044e3fbbc5c49e`
