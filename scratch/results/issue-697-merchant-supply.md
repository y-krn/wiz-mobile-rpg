...
- `origin/main` resolves to that SHA; `git merge-base --is-ancestor
  ...
  measurement JSON.
- Runner: `scratch/sim_depth_material_ev.js`, `// sim-scope: run`; it imports
...
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
  SIM_MERCHANT_EYE_DROPS=1 node scratch/sim_depth_material_ev.js
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
  SIM_MERCHANT_MANA_COST='魔石片:1' node scratch/sim_depth_material_ev.js
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
  SIM_MERCHANT_MANA_COST='魔石片:2' node scratch/sim_depth_material_ev.js
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
  SIM_MERCHANT_MANA_COST='魔石片:3,呪布:1' node scratch/sim_depth_material_ev.js
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
  SIM_MERCHANT_RETURN_WING=1 node scratch/sim_depth_material_ev.js
SIM_RUNS=2000 SIM_CALIBRATION_RUNS=100 SIM_SCENARIOS=workshop-empty \
...
- `node --check scratch/sim_depth_material_ev.js` passed.
