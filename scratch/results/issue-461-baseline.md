...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 戦士 | 25.7% [24.2%, 27.3%; N=3000] | 100.0% [99.9%, 100.0%; N=3000] | 95.2% [94.3%, 95.9%; N=3000] | 4.8% [4.1%, 5.7%; N=3000] | 7.3% [6.5%, 8.3%; N=3000] | 1.8% [0.7%, 4.6%; N=220] | 8.6% [5.6%, 13.1%; N=220] | 0.0% [0.0%, 0.1%; N=3000] | 未観測 [N=0] | 未観測 [N=0] | 3.15 [3.11, 3.18; N=3000] |
| 盗賊 | 62.8% [61.0%, 64.5%; N=3000] | 100.0% [99.9%, 100.0%; N=3000] | 92.3% [91.3%, 93.2%; N=3000] | 7.7% [6.8%, 8.7%; N=3000] | 38.3% [36.5%, 40.0%; N=3000] | 15.9% [13.9%, 18.1%; N=1148] | 21.4% [19.2%, 23.9%; N=1148] | 1.0% [0.7%, 1.4%; N=3000] | 17.2% [7.6%, 34.5%; N=29] 未確定 | 10.3% [3.6%, 26.4%; N=29] 未確定 | 3.92 [3.86, 3.98; N=3000] |
| 僧侶 | 45.7% [44.0%, 47.5%; N=3000] | 100.0% [99.9%, 100.0%; N=3000] | 78.3% [76.8%, 79.7%; N=3000] | 21.7% [20.3%, 23.2%; N=3000] | 42.8% [41.0%, 44.5%; N=3000] | 64.3% [61.6%, 66.9%; N=1283] | 34.9% [32.4%, 37.6%; N=1283] | 9.7% [8.7%, 10.8%; N=3000] | 44.7% [39.1%, 50.4%; N=291] | 14.8% [11.2%, 19.3%; N=291] | 4.45 [4.34, 4.56; N=3000] |
| 魔術師 | 32.4% [30.7%, 34.1%; N=3000] | 100.0% [99.9%, 100.0%; N=3000] | 93.1% [92.2%, 94.0%; N=3000] | 6.9% [6.0%, 7.8%; N=3000] | 5.1% [4.4%, 6.0%; N=3000] | 0.6% [0.1%, 3.6%; N=154] | 12.3% [8.0%, 18.5%; N=154] | 0.0% [0.0%, 0.1%; N=3000] | 未観測 [N=0] | 未観測 [N=0] | 3.10 [3.07, 3.14; N=3000] |
...
- α=.05、計 40 チェック、期待偽陽性 2.0件。
- 内訳: endpoint率 28、Q4/core 8、A1 4。
...
- calibration wall-clock: 87.843s
- simulation wall-clock: 30.451s
- total wall-clock（単純合計）: 118.295s
- total CPU（user+system）: 564.632s
- raw JSONL SHA-256: `44770d377b6cbf86f319163d45876d4b2a9a4b88c30974d97f224701171cffcb`
- summary JSON SHA-256: `007158b245fc002e54864a726c863c1c725605d496ef8a2f78ac4b10efe49618`
