...
```sh
IDENTIFICATION_POLICY=powder STARTING_GEAR_SWEEP_RUNS=1000 STARTING_GEAR_SWEEP_CALIBRATION_RUNS=1000 SIM_SEED=231 node scratch/sim_starting_gear_sweep.js
PROGRESSION_ONLY_REFERENCE=1 PROGRESSION_TRIALS=30 PROGRESSION_RUNS=40 PROGRESSION_CALIBRATION_RUNS=1000 PROGRESSION_ENCOUNTER_SAMPLES=1000 PROGRESSION_SEED=278234 PROGRESSION_IDENTIFICATION_POLICY=powder SIM_PARALLEL=4 node scratch/sim_workshop_progression.js
PROGRESSION_ONLY_REFERENCE=1 PROGRESSION_TRIALS=30 PROGRESSION_RUNS=40 PROGRESSION_CALIBRATION_RUNS=1000 PROGRESSION_ENCOUNTER_SAMPLES=1000 PROGRESSION_SEED=278234 PROGRESSION_IDENTIFICATION_POLICY=legacy SIM_PARALLEL=4 node scratch/sim_workshop_progression.js
IDENTIFICATION_POLICY=powder STATE_COMPARISON_RUNS=1000 STATE_COMPARISON_CALIBRATION_RUNS=1000 SIM_SEED=231 node scratch/sim_workshop_state_comparison.js
IDENTIFICATION_POLICY=legacy STATE_COMPARISON_RUNS=1000 STATE_COMPARISON_CALIBRATION_RUNS=1000 SIM_SEED=231 node scratch/sim_workshop_state_comparison.js
IDENTIFICATION_POLICY=powder SIM_RUNS=1000 SIM_CALIBRATION_RUNS=1000 SIM_SCENARIOS=workshop-complete SIM_SEED=231 SIM_PARALLEL=4 node scratch/sim_depth_material_ev.js
```
