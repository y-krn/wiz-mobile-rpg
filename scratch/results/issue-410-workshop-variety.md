...
PROGRESSION_ONLY_REFERENCE=1 PROGRESSION_TRIALS=30 PROGRESSION_RUNS=40 PROGRESSION_CALIBRATION_RUNS=1000 PROGRESSION_ENCOUNTER_SAMPLES=1000 PROGRESSION_SEED=278234 PROGRESSION_IDENTIFICATION_POLICY=powder node scratch/sim_workshop_progression.js
PROGRESSION_ONLY_REFERENCE=1 PROGRESSION_TRIALS=30 PROGRESSION_RUNS=40 PROGRESSION_CALIBRATION_RUNS=1000 PROGRESSION_ENCOUNTER_SAMPLES=1000 PROGRESSION_SEED=278234 PROGRESSION_IDENTIFICATION_POLICY=legacy node scratch/sim_workshop_progression.js
...
IDENTIFICATION_POLICY=powder SIM_RUNS=1000 SIM_CALIBRATION_RUNS=1000 SIM_SCENARIOS=workshop-complete SIM_SEED=231 node scratch/sim_depth_material_ev.js
```
