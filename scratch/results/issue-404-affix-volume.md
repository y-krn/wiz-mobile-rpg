...
- `high` / `upper` は深さの改善がなお #409 の slot↑経路より小さく、core過剰の副作用も残る。`upper` は #447 (2) の上界条件であり、提案値ではない。
- 本 issue の現実的な affix量では #409 の代替にならない。次は #409 の slot↑経路へ進む。
...
| scenario | base | conservative | balanced | high | upper |
| --- | ---: | ---: | ---: | ---: | ---: |
| workshop-empty | 3.021 [2.985, 3.056] | 3.028 [2.991, 3.065] | 3.081 [3.041, 3.120] | 3.099 [3.058, 3.140] | 3.103 [3.062, 3.145] |
| workshop-stats | 3.250 [3.209, 3.291] | 3.264 [3.222, 3.305] | 3.302 [3.258, 3.346] | 3.335 [3.289, 3.381] | 3.355 [3.307, 3.402] |
| workshop-gear | 3.470 [3.427, 3.514] | 3.477 [3.433, 3.520] | 3.540 [3.493, 3.587] | 3.576 [3.527, 3.626] | 3.612 [3.560, 3.663] |
| workshop-blood-wand | 3.528 [3.482, 3.574] | 3.512 [3.467, 3.556] | 3.587 [3.538, 3.635] | 3.641 [3.590, 3.692] | 3.685 [3.632, 3.738] |
| workshop-blood-wand-spells | 3.609 [3.563, 3.655] | 3.612 [3.566, 3.658] | 3.693 [3.642, 3.743] | 3.679 [3.629, 3.729] | 3.692 [3.640, 3.744] |
| workshop-core-pools | 3.552 [3.505, 3.598] | 3.567 [3.520, 3.614] | 3.660 [3.608, 3.711] | 3.671 [3.618, 3.723] | 3.750 [3.694, 3.806] |
| workshop-complete | 3.724 [3.675, 3.773] | 3.730 [3.681, 3.780] | 3.816 [3.763, 3.869] | 3.833 [3.778, 3.887] | 3.887 [3.830, 3.945] |
...
PR #447 の全run平均は base 3.45 [3.42, 3.48]、#409 の slot↑ / affix据え置き経路は 4.18 [4.14, 4.22]（base差 +0.73）。今回の同じ7条件集計では、現行 base 3.450 [3.434, 3.467]、upper 3.583 [3.564, 3.603]（base差 +0.133）だった。

したがって、#404の上界でも #409 の改善量の約18%（0.133 / 0.73）で、balanced は約10%、high は約13%に留まる。現実的変更で #409 に十分届かないため、#409 を進める根拠になる。#404では balance を採用せず、データ変更なしで完了とする。
...
なし。`src/`、`scratch/sim_depth_material_ev.js`、`scratch/sim_workshop_progression.js`、および既存の共通 runner は変更していない。今回追加した profile 適用・集計 harness は既存 runner を呼び出すだけなので、PR #447 以前の測定を runner SHA変更として取り直す対象にはしない。
