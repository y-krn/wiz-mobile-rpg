...
const readScratch = name => fs.readFileSync(path.join(scratchDir, name), "utf8");
const failures = [];

const workshopSource = readScratch("sim_workshop_progression.js");
const depthSource = readScratch("sim_depth_material_ev.js");
...
const balanceFiles = fs.readdirSync(scratchDir)
