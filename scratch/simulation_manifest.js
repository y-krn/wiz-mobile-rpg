...
export const SIMULATION_MANIFEST = Object.freeze({
  ...
  balanceImpactPaths: Object.freeze([
    ...
    { pattern: "src/combat_logic/auto_action.js", domains: ["combat"] },
    ...
    { pattern: "src/combat_logic/item_resolution.js", domains: ["combat"] },
    ...
    { pattern: "src/data.js", domains: ["combat", "equipment", "maps", "progression"] },
