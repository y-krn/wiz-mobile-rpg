...
function run() {
  ...
  assert.equal(applyPhysicalResistance(0, cappedResistance), 0, "physical resistance output allows zero");
  assert.equal(calculatePhysicalAttackFormula({ weaponAtk: 0, str: 10, def: 18 }), 0);
