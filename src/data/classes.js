...
export const CLASS_PASSIVES = {
  Mage: { label: "魔導適性", bonuses: { arcane: 20, killMp: 1, spellCycleMp: 2, mpWard: 1, killHeal: 8 } },
  ...
  Thief: { label: "身軽さ", bonuses: { evasion: 35 } },
  Fighter: { label: "守護適性", bonuses: { guardian: 20, killHeal: 2 } },
  Bishop: { label: "鑑定・退魔眼", bonuses: { identifyDiscount: 20, antiUndead: 20 } },
  Ranger: { label: "野外戦術", bonuses: {} },
