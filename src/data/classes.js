...
// いずれも探索/MPに連動するため、常時の回復薬供給ではなくクラス個性を保つ。
export const CLASS_PASSIVES = {
  Mage: { label: "魔導適性", bonuses: { arcane: 20, trapGuard: 50, killMp: 1, spellCycleMp: 2, mpWard: 4 } },
  ...
  Fighter: { label: "守護適性", bonuses: { guardian: 20, trapGuard: 40 } },
