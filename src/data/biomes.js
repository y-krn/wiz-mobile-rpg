...
export const BIOMES = Object.freeze([
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "坑道の湧き水", merchant: "荷車の商人", camp: "坑夫宿舎跡" },
  ...
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "朽ちた聖水盤", merchant: "墓守の商人", camp: "礼拝堂跡" },
  ...
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "裂溝の雫", merchant: "巣渡りの商人", camp: "糸紡ぎ場跡" },
  ...
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "溢れる魔導水", merchant: "書庫漁りの商人", camp: "読書室跡" },
  ...
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "冷却の泉", merchant: "炉守りの商人", camp: "鍛冶場跡" },
  ...
  biome({
    ...
    theme: {
      ...
      eventSkins: { spring: "深淵の雫", merchant: "玉座渡りの商人", camp: "王座の間跡" },
