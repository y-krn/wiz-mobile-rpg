...
export const ITEMS = {
  // Weapons
  DAGGER: { id: "DAGGER", name: "ダガー", type: "weapon", hands: 1, atk: 3, randRange: [1, 3], desc: "シンプルな短剣。攻撃力+3 [全員用]", classes: ["Fighter", "Thief", "Priest", "Mage", "Samurai", "Bishop", "Ranger", "Ninja"], tags: ["iron", "ambush"] },
  WAND: { id: "WAND", name: "魔術師の杖", type: "weapon", hands: 1, atk: 1.5, randRange: [2, 2], desc: "神秘的な魔力を宿した木の杖。攻撃力+1.5 呪文威力+10% [僧・魔・司用]", classes: ["Priest", "Mage", "Bishop"], tags: ["spirit", "appraisal"] },
  SAGE_STAFF: { id: "SAGE_STAFF", name: "賢者の杖", type: "weapon", hands: 2, atk: 3, randRange: [2, 2], desc: "鑑定術に長けた賢者の杖。攻撃力+3 [僧・魔・司用]", classes: ["Priest", "Mage", "Bishop"], tags: ["spirit", "appraisal"] },
  ARCH_WAND: { id: "ARCH_WAND", name: "大魔道の杖", type: "weapon", hands: 2, atk: 4.5, randRange: [1, 3], desc: "禁呪の紋が刻まれた高位の杖。攻撃力+4.5 [魔・司用]", classes: ["Mage", "Bishop"], tags: ["spirit", "curse"] },
  SHORT_SWORD: { id: "SHORT_SWORD", name: "ショートソード", type: "weapon", hands: 1, atk: 9, randRange: [1, 3], desc: "使いやすい鉄の小太刀。攻撃力+9 [戦・盗・侍・野用]", classes: ["Fighter", "Thief", "Samurai", "Ranger"], tags: ["iron", "blade"] },
  FIGHTER_SABER: { id: "FIGHTER_SABER", name: "鍛錬サーベル", type: "weapon", hands: 1, atk: 12, randRange: [2, 2], desc: "戦士向けに軽く鍛えた片刃剣。攻撃力+12 [戦用]", classes: ["Fighter"], tags: ["iron", "blade"] },
  RAPIER: { id: "RAPIER", name: "レイピア", type: "weapon", hands: 1, atk: 12, randRange: [1, 3], desc: "突きに優れた細身の剣。攻撃力+12 [盗・司・野・忍用]", classes: ["Thief", "Bishop", "Ranger", "Ninja"], tags: ["iron", "blade"] },
  NINJA_DAGGER: { id: "NINJA_DAGGER", name: "忍びの短刀", type: "weapon", hands: 1, atk: 13.5, randRange: [1, 3], desc: "暗殺用の鋭い短刀。攻撃力+13.5 [盗・忍用]", classes: ["Thief", "Ninja"], tags: ["ambush", "poison"] },
  VENOM_FANG: { id: "VENOM_FANG", name: "毒牙の短刀", type: "weapon", hands: 1, atk: 13.5, randRange: [0, 4], desc: "毒を仕込む溝を持つ短刀。攻撃力+13.5 [盗・忍用]", classes: ["Thief", "Ninja"], tags: ["poison", "ambush"] },
  LONG_SWORD: { id: "LONG_SWORD", name: "ロングソード", type: "weapon", hands: 1, atk: 18, randRange: [0, 4], desc: "両刃の美しい鋼鉄長剣。攻撃力+18 [戦・侍・野用]", classes: ["Fighter", "Samurai", "Ranger"], tags: ["iron", "blade"] },
  NINJA_BLADE: { id: "NINJA_BLADE", name: "忍刀", type: "weapon", hands: 1, atk: 21, randRange: [1, 3], desc: "素早い斬撃に向いた片刃の忍刀。攻撃力+21 [盗・忍用]", classes: ["Thief", "Ninja"], tags: ["ambush", "blade"] },
  FLAME_SWORD: { id: "FLAME_SWORD", name: "フレイムソード", type: "weapon", hands: 1, atk: 21, randRange: [0, 4], desc: "火のルーンを刻んだ剣。攻撃力+21 [戦・侍・野用]", classes: ["Fighter", "Samurai", "Ranger"], tags: ["fire", "blade"] },
  CLAYMORE: { id: "CLAYMORE", name: "クレイモア", type: "weapon", hands: 2, atk: 27, randRange: [0, 4], desc: "重量のある両手大剣。攻撃力+27 [戦・侍用]", classes: ["Fighter", "Samurai"], tags: ["iron", "blade"] },
  MOONSHADOW: { id: "MOONSHADOW", name: "月影丸", type: "weapon", hands: 1, atk: 30, randRange: [0, 4], desc: "月光を吸う黒刃の忍刀。攻撃力+30 [盗・忍用]", classes: ["Thief", "Ninja"], tags: ["ambush", "evasion", "blade"] },
  KATANA: { id: "KATANA", name: "名刀ムラマサ", type: "weapon", hands: 2, atk: 37.5, randRange: [0, 4], desc: "伝説の妖刀。攻撃力+37.5 [戦・侍用]", classes: ["Fighter", "Samurai"], tags: ["blood", "blade", "curse"] },
  MACE: { id: "MACE", name: "メイス", type: "weapon", hands: 1, atk: 7.5, randRange: [0, 4], desc: "打撃用の重い金属槌。攻撃力+7.5 [戦・僧・司・野用]", classes: ["Fighter", "Priest", "Bishop", "Ranger"], tags: ["iron"] },
  SACRED_MACE: { id: "SACRED_MACE", name: "聖印メイス", type: "weapon", hands: 1, atk: 10.5, randRange: [1, 3], desc: "不死者を祓う祝福を受けた槌。攻撃力+10.5 [僧・司・野用]", classes: ["Priest", "Bishop", "Ranger"], tags: ["holy", "spirit"] },
  HOLY_STAFF: { id: "HOLY_STAFF", name: "祝聖の錫杖", type: "weapon", hands: 1, atk: 9, randRange: [2, 2], desc: "祝福を受けた司祭用の錫杖。攻撃力+9 [僧・司用]", classes: ["Priest", "Bishop"], tags: ["holy", "spirit"] },
  ...
  LEGENDARY_SWORD: { id: "LEGENDARY_SWORD", name: "神剣エクスカリバー", type: "weapon", hands: 2, atk: 60, randRange: [0, 4], desc: "聖なる光を放つ伝説の神剣。攻撃力+60 [戦・侍用]", classes: ["Fighter", "Samurai"], tags: ["holy", "blade"] },
  ...
  SEALED_EXCALIBUR: { id: "SEALED_EXCALIBUR", name: "封印された聖剣", type: "weapon", hands: 2, atk: 39, randRange: [0, 4], desc: "封印が施された伝説の聖剣。攻撃力+39 [戦・侍用]", classes: ["Fighter", "Samurai"], tags: ["curse", "blade"] },
  HOLY_BLADE: { id: "HOLY_BLADE", name: "聖騎士の剣", type: "weapon", hands: 1, atk: 36, randRange: [1, 3], desc: "不死・悪魔を退ける聖なる剣。攻撃力+36 不死・悪魔特効+20% [戦・僧・侍・野用]", classes: ["Fighter", "Priest", "Samurai", "Ranger"], tags: ["holy", "blade"] },
