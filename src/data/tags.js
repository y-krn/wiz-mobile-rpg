export const TAGS = {
  ...
  contract: { name: "任務", desc: "ランクエストの成果を高める技量" },
...
export const TAG_EFFECT_MAP = {
  holy: { name: "聖印", type: "antiUndead", value: 20, desc: "不死特効+20%", matCost: 3 },
  spirit: { name: "霊印", type: "mp", value: 2, desc: "最大MP+2", matCost: 2 },
  appraisal: { name: "鑑印", type: "identifyDiscount", value: 10, desc: "鑑定割引+10%", matCost: 2 },
  poison: { name: "毒印", type: "poisonWard", value: 25, desc: "毒耐性+25%", matCost: 2 },
  trap: { name: "罠印", type: "trapBonus", value: 10, desc: "罠解除率+10%", matCost: 2 },
  iron: { name: "鉄印", type: "def", value: 3, desc: "防御力+3", matCost: 2 },
  ward: { name: "守印", type: "guardian", value: 10, desc: "守護適性+10%", matCost: 3 },
  dragon: { name: "竜印", type: "antiDragon", value: 20, desc: "竜特効+20%", matCost: 4 },
  fire: { name: "火印", type: "atk", value: 3, desc: "攻撃力+3", matCost: 3 },
  curse: { name: "呪印", type: "curse", value: 0, desc: "渇血の呪い (攻撃+15 / 回復-20%)", matCost: 1 },
  demon: { name: "魔印", type: "antiDemon", value: 20, desc: "悪魔特効+20%", matCost: 4 },
  blood: { name: "血印", type: "followUp", value: 10, desc: "連撃適性+10%", matCost: 3 },
  material: { name: "採印", type: "materialFind", value: 10, desc: "素材発見率+10%", matCost: 2 },
  fortune: { name: "財印", type: "materialFind", value: 10, desc: "素材発見率+10%", matCost: 3 },
  contract: { name: "任務印", type: "contractReward", value: 10, desc: "クエスト報酬+10%", matCost: 3 },
