...
export const MONSTER_ROLE_BY_NAME = Object.freeze({
  ...
  "墓守の巨躯": ENEMY_ROLES.AGGRESSOR,
  "這い寄る影": ENEMY_ROLES.AGGRESSOR,
  "禁書の番人": ENEMY_ROLES.AGGRESSOR,
  "灼熱の徘徊者": ENEMY_ROLES.AGGRESSOR,
  "深淵の徘徊者": ENEMY_ROLES.AGGRESSOR,
...
const MONSTER_DATA = [
  ...
  { name: "針甲虫", level: 2, hp: 32, atk: 5, def: 5, exp: 160, spriteType: "biter", traits: ["reflectPhysical"], physicalReflect: { rate: 0.3 }, tags: ["beast"], color: "#ff9500" },
  ...
  { name: "煙幕盗賊", level: 2, hp: 36, atk: 7, def: 2, exp: 150, spriteType: "kobold", isBlinding: true, statusChance: 0.25, statusAttackPattern: "blind_snipe", color: "#8e8e93" },
  { name: "催眠コウモリ", level: 2, hp: 24, atk: 5, def: 2, exp: 150, spriteType: "bat", traits: ["evasive"], evasionChance: 0.20, isSleepInflicting: true, statusChance: 0.3, tags: ["beast"], color: "#e5ff00" },
  { name: "霧の亡霊", level: 3, hp: 44, atk: 7, def: 2, exp: 350, spriteType: "spirit", traits: ["evasive"], evasionChance: 0.22, physResist: 0.3, magicResist: -0.3, tags: ["undead", "spirit"], color: "#00e5ff" },
  ...
  { name: "鋼殻ビートル", level: 4, hp: 88, atk: 12, def: 12, exp: 1100, spriteType: "biter", traits: ["reflectPhysical"], physicalReflect: { rate: 0.4 }, magicResist: -0.25, tags: ["beast"], color: "#ff9500" },
  ...
  { name: "結界の守護者", level: 5, hp: 130, atk: 12, def: 8, exp: 1900, spriteType: "flack", traits: ["buffPhysicalDef", "buffMagicDef"], traitChance: 0.35, buffValue: 3, tags: ["demon"], color: "#34c759" },
