export const MONSTERS = [
  ...
  { name: "キラーラビット", level: 2, hp: 32, atk: 12, def: 4, exp: 120, gold: 20, spriteType: "rabbit", tags: ["beast"], color: "#ff8c00" },
  ...
  { name: "ワーウルフ", level: 3, hp: 72, atk: 14, def: 5, exp: 340, gold: 60, spriteType: "orc", isParalyzing: true, statusChance: 0.3, tags: ["beast"], color: "#ff8c00" },
  ...
  { name: "フラッシュバット", level: 2, hp: 24, atk: 5, def: 2, exp: 100, gold: 15, spriteType: "bat", isBlinding: true, row: "back", tags: ["beast"], color: "#e5ff00" },
  ...
  { name: "メタルパピー", level: 4, hp: 16, atk: 5, def: 10, exp: 600, gold: 500, spriteType: "biter", fleeChance: 0.50, color: "#ffd700", isRare: true, treasureRare: true },
  ...
  { name: "呪文喰い", level: 3, hp: 68, atk: 10, def: 4, exp: 420, gold: 60, spriteType: "spirit", magicResist: 0.75, tags: ["spirit"], color: "#4cd964" },
  ...
  { name: "ブラッドバット群", level: 2, hp: 20, atk: 5, def: 1, exp: 90, gold: 10, spriteType: "bat", tags: ["beast"], color: "#ff3b30" },
  ...
  { name: "群れネズミ", level: 1, hp: 12, atk: 3, def: 0, exp: 35, gold: 4, spriteType: "rabbit", tags: ["beast"], color: "#8e8e93" },
  ...
  { name: "火薬コウモリ", level: 1, hp: 22, atk: 4, def: 1, exp: 80, gold: 8, spriteType: "bat", traits: ["selfDestruct"], tags: ["beast"], color: "#ff9500" },
  ...
  { name: "マナドレイン", level: 2, hp: 36, atk: 4, def: 2, exp: 180, gold: 22, spriteType: "spirit", traits: ["drainMp", "targetBackRow"], traitChance: 0.35, isSniper: true, row: "back", tags: ["spirit"], color: "#00e5ff" },
  ...
  { name: "催眠コウモリ", level: 2, hp: 24, atk: 5, def: 2, exp: 110, gold: 15, spriteType: "bat", isSleepInflicting: true, statusChance: 0.3, row: "back", tags: ["beast"], color: "#e5ff00" },
  ...
  { name: "双頭の番犬", level: 5, hp: 140, atk: 15, def: 8, exp: 1600, gold: 150, spriteType: "dragon", traits: ["multiAction"], tags: ["beast"], color: "#ff9500" },
  ...
  { name: "黒曜の魔導士", level: 5, hp: 116, atk: 10, def: 6, exp: 2000, gold: 220, spriteType: "mage", spell: "LAHALITO", spellChance: 0.35, magicResist: 0.6, row: "back", color: "#ff3b30" },
  ...
  { name: "破滅の導師", level: 5, hp: 120, atk: 12, def: 7, exp: 2100, gold: 240, spriteType: "mage", traits: ["chargeAttack"], traitChance: 0.35, row: "back", color: "#af52de" },
  { name: "命喰いの影", level: 5, hp: 108, atk: 15, def: 5, exp: 1800, gold: 180, spriteType: "spirit", traits: ["antiHeal"], traitChance: 0.3, tags: ["spirit"], color: "#5856d6" },
