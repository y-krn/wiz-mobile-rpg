...
const MONSTER_DATA = [
  ...
  { name: "ゴブリンの呪術師", level: 1, hp: 20, atk: 4, def: 1, exp: 50, spriteType: "kobold", spell: "HALITO", spellChance: 0.3, row: "back", color: "#00ff66" },
  ...
  { name: "はぐれ魔術師", level: 3, hp: 44, atk: 8, def: 4, exp: 280, spriteType: "mage", spell: "HALITO", spellChance: 0.3, row: "back", color: "#da70d6" },
  ...
  { name: "フラッシュバット", level: 2, hp: 24, atk: 5, def: 2, exp: 100, spriteType: "bat", isBlinding: true, row: "back", tags: ["beast"], color: "#e5ff00" },

  { name: "マスターメイジ", level: 4, hp: 76, atk: 9, def: 5, exp: 650, spriteType: "mage", spell: "LAHALITO", spellChance: 0.35, magicResist: 0.3, row: "back", color: "#ff3b30" },
  ...
  { name: "プリーストデーモン", level: 5, hp: 120, atk: 12, def: 6, exp: 800, spriteType: "flack", spell: "DIALMA", spellChance: 0.3, tags: ["demon"], row: "back", color: "#34c759" },
  { name: "スケルトンアーチャー", level: 2, hp: 40, atk: 9, def: 3, exp: 150, spriteType: "skeleton", isSniper: true, tags: ["undead"], row: "back", color: "#af52de" },
  { name: "ダークアサシン", level: 3, hp: 56, atk: 14, def: 4, exp: 350, spriteType: "kobold", isSniper: true, row: "back", color: "#ff3b30" },
  ...
  { name: "まどろみ胞子", level: 1, hp: 20, atk: 4, def: 1, exp: 70, spriteType: "wisp", isSleepInflicting: true, statusChance: 0.2, row: "back", color: "#00e5ff" },
  ...
  { name: "呪いの小鏡", level: 2, hp: 24, atk: 3, def: 1, exp: 180, spriteType: "wisp", traits: ["reflectMagic"], magicReflect: { chance: 0.5 }, row: "back", color: "#ffffff" },
  ...
  { name: "祈祷ゴブリン", level: 2, hp: 36, atk: 4, def: 2, exp: 190, spriteType: "orc", spell: "DIOS", spellChance: 0.35, row: "back", color: "#34c759" },
  { name: "マナドレイン", level: 2, hp: 36, atk: 4, def: 2, exp: 180, spriteType: "spirit", traits: ["drainMp", "targetBackRow"], traitChance: 0.35, isSniper: true, row: "back", tags: ["spirit"], color: "#00e5ff" },
  { name: "煙幕盗賊", level: 2, hp: 36, atk: 7, def: 2, exp: 210, spriteType: "kobold", isBlinding: true, statusChance: 0.25, row: "back", color: "#8e8e93" },
  { name: "催眠コウモリ", level: 2, hp: 24, atk: 5, def: 2, exp: 110, spriteType: "bat", isSleepInflicting: true, statusChance: 0.3, row: "back", tags: ["beast"], color: "#e5ff00" },
  ...
  { name: "魔封じの目玉", level: 3, hp: 48, atk: 6, def: 2, exp: 360, spriteType: "wisp", traits: ["silence", "targetBackRow"], traitChance: 0.35, row: "back", color: "#ffcc00" },
  { name: "骨の鼓手", level: 3, hp: 48, atk: 5, def: 3, exp: 380, spriteType: "skeleton", traits: ["buffAtk"], traitChance: 0.35, buffValue: 3, tags: ["undead"], row: "back", color: "#dcdcdc" },
  { name: "弱体の魔女", level: 3, hp: 52, atk: 6, def: 3, exp: 420, spriteType: "mage", traits: ["debuffMagicDef"], traitChance: 0.3, row: "back", color: "#da70d6" },
  { name: "解呪の司祭", level: 3, hp: 60, atk: 7, def: 4, exp: 450, spriteType: "mage", traits: ["cleanseAlly"], traitChance: 0.35, row: "back", color: "#34c759" },
  ...
  { name: "魔鏡の司祭", level: 4, hp: 76, atk: 8, def: 5, exp: 1000, spriteType: "mage", traits: ["reflectMagic"], magicReflect: { chance: 0.6 }, row: "back", color: "#af52de" },
  ...
  { name: "沈黙の修道士", level: 4, hp: 80, atk: 10, def: 6, exp: 980, spriteType: "mage", traits: ["silence"], traitChance: 0.18, row: "back", color: "#dcdcdc" },
  { name: "召喚する悪魔", level: 4, hp: 90, atk: 12, def: 6, exp: 1150, spriteType: "flack", traits: ["summonAlly"], summon: { name: "ゴブリンの呪術師", maxAllies: 5 }, row: "back", tags: ["demon"], color: "#ff3b30" },
  { name: "双頭の番犬", level: 5, hp: 140, atk: 15, def: 8, exp: 1600, spriteType: "dragon", traits: ["multiAction"], tags: ["beast"], color: "#ff9500" },
  { name: "結界の守護者", level: 5, hp: 130, atk: 12, def: 8, exp: 1900, spriteType: "flack", traits: ["buffPhysicalDef", "buffMagicDef"], traitChance: 0.35, buffValue: 3, row: "back", color: "#34c759" },
  ...
  { name: "黒曜の魔導士", level: 5, hp: 116, atk: 10, def: 6, exp: 2000, spriteType: "mage", spell: "LAHALITO", spellChance: 0.35, magicResist: 0.6, row: "back", color: "#ff3b30" },
  ...
  { name: "破滅の導師", level: 5, hp: 120, atk: 12, def: 7, exp: 2100, spriteType: "mage", traits: ["chargeAttack"], traitChance: 0.35, row: "back", color: "#af52de" },
  ...
  { name: "灰燼の術士", level: 5, hp: 104, atk: 9, def: 5, exp: 1900, spriteType: "mage", traits: ["counterSpell"], counterSpell: { chance: 0.2 }, row: "back", color: "#ff9500" },
