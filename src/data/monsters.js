...
const MONSTER_DATA = [
  ...
  { name: "マナドレイン", level: 2, hp: 36, atk: 4, def: 2, exp: 180, spriteType: "spirit", traits: ["drainMp", "targetBackRow"], traitChance: 0.35, isSniper: true, tags: ["spirit"], color: "#00e5ff" },
  ...
  { name: "魔封じの目玉", level: 3, hp: 48, atk: 6, def: 2, exp: 360, spriteType: "wisp", traits: ["silence", "targetBackRow"], traitChance: 0.35, color: "#ffcc00" },
