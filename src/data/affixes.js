export const AFFIX_BALANCE = {
  ...
  supportValuesByRarity: {
    ...
    escapeChance: { magic: 10, rare: 15, epic: 20 },
...
const SUPPORT_BUILD_ROLES = Object.freeze({
  atk: "reinforce", def: "reinforce", hp: "reinforce", mp: "reinforce",
  ...
  antiBeast: "pivot", antiSpirit: "pivot", spellAccuracy: "pivot",
...
export const SUPPORT_AFFIXES = [
  ...
  support("escapeChance", "離脱補助", "戦闘からの離脱成功率が増加する。", "basic", { unit: "%" }),
...
export const CORE_AFFIXES = [
  ...
  },
  {
    ...
    kind: "core",
    jpName: "呪飼いの鎖",
    desc: "装備中の呪い1個につき攻撃力と呪文威力が3%増加する。",
    slot: "accessory",
    cost: 10,
    params: { atkPerCurse: 3, spellPowerPerCurse: 3 },
    buildRole: "convert",
    buildAxis: "main",
    poolGroup: "combat",
    enabled: true
