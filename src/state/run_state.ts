...
export interface NormalizedCurrentRun {
  ...
  trialBands: Record<string, unknown>;
...
const RECORD_FIELDS = [
  ...
  "trialBands", "eliteFloors", "eliteOmenSteps", "defeatsByRole", "codexRewards",
  "departureEquipment"
] as const;
...
const ARRAY_FIELDS = [
  ...
  "defeatedMilestones", "visitedMilestoneMerchants", "quests", "firstKillsBefore",
